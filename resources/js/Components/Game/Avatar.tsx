...
> {
    ...
    render() {
        const { Characterref, jump, happy, feeling, open, hat, ribbon } =
            this.props;
        // var hat;
        // var mask;
        // var shirt;
                    ...
                    <div id="Avatar">
                        <div className="">
                            ...
                            <div className=" head">
                                <img
                                    className="hat"
                                    src={this.props.hat?.asset_url}
                                    alt=""
                                />
                                <div className=" face" ref={Characterref}>
                            ...
                            <div className=" body">
                                ...
                                <img
                                    id="ribbon"
                                    src="https://www.svgrepo.com/show/423813/ribbon-origami-paper.svg"
                                    alt=""
                                />
                            </div>
